...
def index():
    ...
    return render_template('dashboard/index.html', rentals=rentals, return_state=return_state)    
...
def signin():
    ...
    if customer_signin.is_submitted():
        ...
        if not customer:
            ...
            return render_template('dashboard/signin.html', customer_signin=customer_signin)
...
def signup():
    ...
    return render_template('dashboard/signup.html', customer_signup=customer_signup)
